...
This is home to the API documentation for the Town Energy Balance (TEB) model, for the project's website, please go to [https://github.com/teb-model/teb](https://github.com/teb-model/teb).
